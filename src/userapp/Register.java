...
public class Register extends javax.swing.JFrame {
    ...
    private void submitButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submitButtonMouseClicked
        ...
        if (!pass1.equals(repass1)) {
            ...
            String table = "user";
            String columns = "first_name,middle_name,last_name,email,password";
            String values[] = {fname,mname,lname,email,pass1};
            
            c.addData(table, columns, values);

            JOptionPane.showMessageDialog(this, "Adding " + fname + " to database");
            Login log = new Login();
